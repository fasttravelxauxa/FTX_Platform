  ...
  return (
    <div className="min-h-screen bg-crusoe-50 flex flex-col font-sans">
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="relative overflow-hidden bg-gradient-to-b from-crusoe-950 via-crusoe-900 to-crusoe-950 text-white py-20 lg:py-28">
                  ...
                  <div className="p-6 bg-gradient-to-t from-crusoe-950 via-crusoe-950/90 to-transparent">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <h3 className="text-xl font-extrabold text-white">SUV Jetour Deluxe</h3>
                      </div>
        ...
        <section id="comprobantes" className="py-12 bg-crusoe-900 text-white border-b border-crusoe-800">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl border border-crusoe-700/80 bg-crusoe-950/90 p-8 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-3 max-w-2xl">
                ...
                <p className="text-xs sm:text-sm text-crusoe-200 leading-relaxed">
              ...
              <div className="shrink-0 flex flex-col items-center gap-3">
                <div className="rounded-2xl bg-crusoe-900 p-4 border border-crusoe-700 text-center text-xs space-y-1">
                  <Building2 className="h-6 w-6 text-crusoe-400 mx-auto" />
                  <span className="font-bold block text-white">Entrega vía WhatsApp</span>
                  <span className="text-crusoe-300 text-[11px]">PDF y XML Oficial</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="como-funciona" className="py-16 bg-white border-b border-crusoe-200">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-xs font-bold uppercase tracking-widest text-crusoe-600">Proceso Transparente</h2>
              <p className="text-3xl font-extrabold text-crusoe-950 mt-1 sm:text-4xl">
                ¿Cómo funciona tu reserva en Fast Travel Xauxa?
              </p>
              <p className="text-sm text-crusoe-800 mt-3">
                Sin complicaciones ni tarifas ocultas. Coordinación directa por mensajes de WhatsApp.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              <div className="relative rounded-2xl border border-crusoe-200 bg-crusoe-50/60 p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-base font-bold text-crusoe-950">Elige tu Servicio</h3>
                <p className="text-xs text-crusoe-800 mt-2 leading-relaxed">
              ...
              <div className="relative rounded-2xl border border-crusoe-200 bg-crusoe-50/60 p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-base font-bold text-crusoe-950">Fecha, Hora y Vuelo</h3>
                <p className="text-xs text-crusoe-800 mt-2 leading-relaxed">
                  Ingresa tu aerolínea y número de vuelo. Calculamos la tarifa de forma transparente.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-crusoe-200 bg-crusoe-50/60 p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-base font-bold text-crusoe-950">Adelanto 50% y Comprobante</h3>
                <p className="text-xs text-crusoe-800 mt-2 leading-relaxed">
              ...
              <div className="relative rounded-2xl border border-crusoe-200 bg-crusoe-50/60 p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-base font-bold text-crusoe-950">Confirmación y Viaje</h3>
                <p className="text-xs text-crusoe-800 mt-2 leading-relaxed">
        ...
        {/* SERVICES CATALOG */}
        <section id="servicios" className="py-20 bg-crusoe-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
              <div>
                <span className="text-xs font-bold uppercase tracking-widest text-crusoe-700">Catálogo Oficial</span>
                <h2 className="text-3xl font-extrabold text-crusoe-950 mt-1 sm:text-4xl">
                  Nuestros Servicios de Transporte
                </h2>
              </div>
              <p className="text-xs text-crusoe-800 max-w-md">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="rounded-3xl border-2 border-crusoe-300 bg-white p-6 shadow-lg hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-crusoe-100 text-crusoe-700">
                      <Plane className="h-6 w-6" />
                    </div>
                    <span className="rounded-full bg-crusoe-100 px-3 py-1 text-xs font-bold text-crusoe-800">
                      Recomendado
                    </span>
                  </div>
                  <h3 className="text-xl font-bold text-crusoe-950">Aeropuerto Privado</h3>
                  <p className="text-xs text-crusoe-800 mt-2">
                    Servicio exclusivo puerta a puerta desde/hacia el Aeropuerto de Jauja ↔ Huancayo.
                  </p>
                  <div className="mt-6 border-t border-crusoe-100 pt-4 space-y-2 text-xs text-crusoe-900">
                    <div className="flex justify-between font-semibold">
                      <span>Tarifa base Huancayo Centro:</span>
                      <span className="text-crusoe-700 text-base font-extrabold">S/ 80.00</span>
                    </div>
                    <div className="flex justify-between text-crusoe-700">
                      <span>Chilca / Periferia:</span>
                      <span>+S/ 10.00 (S/ 90.00)</span>
                    </div>
                    <div className="flex items-center gap-1.5 text-crusoe-800 pt-1">
              ...
              <div className="rounded-3xl border-2 border-crusoe-300 bg-white p-6 shadow-lg hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-crusoe-950">Aeropuerto Compartido</h3>
                  <p className="text-xs text-crusoe-800 mt-2">
                    Viaje ejecutivo en SUV Jetour compartida. Máximo 4 pasajeros. Aeropuerto Jauja ↔ Plaza Constitución.
                  </p>
                  <div className="mt-6 border-t border-crusoe-100 pt-4 space-y-2 text-xs text-crusoe-900">
                    <div className="flex justify-between font-semibold">
                      <span>Precio por asiento:</span>
                      <span className="text-crusoe-700 text-base font-extrabold">S/ 20.00</span>
                    </div>
                    <div className="flex justify-between text-crusoe-700">
                    ...
                    <div className="flex items-center gap-1.5 text-crusoe-800 pt-1">
                      <CheckCircle2 className="h-3.5 w-3.5 text-crusoe-600" />
                      <span>Reserva hasta 48h antes</span>
                    </div>
                  </div>
                </div>
                <div className="mt-6">
              ...
              <div className="rounded-3xl border-2 border-crusoe-300 bg-white p-6 shadow-lg hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-crusoe-950">Excursiones / Renta</h3>
                  <p className="text-xs text-crusoe-800 mt-2">
                  ...
                  <div className="mt-6 border-t border-crusoe-100 pt-4 space-y-2 text-xs text-crusoe-900">
                    <div className="flex justify-between font-semibold">
                      ...
                      <span className="text-crusoe-700 text-base font-extrabold">S/ 50.00 / hora</span>
                    </div>
                    <div className="flex justify-between text-crusoe-700">
        ...
        <section id="vehiculo" className="py-20 bg-white border-t border-crusoe-200">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="text-xs font-bold uppercase tracking-widest text-crusoe-600">Flota Oficial</span>
              <h2 className="text-3xl font-extrabold text-crusoe-950 mt-1 sm:text-4xl">
                Nuestra Camioneta SUV Jetour
              </h2>
              <p className="text-sm text-crusoe-800 mt-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="rounded-2xl overflow-hidden border border-crusoe-200 shadow-md">
                ...
                <div className="p-4 bg-crusoe-50">
                  <h4 className="font-bold text-crusoe-950 text-sm">Vista Exterior Elegante</h4>
                  <p className="text-xs text-crusoe-800 mt-1">Carrocería impecable, amplio espacio y máximo confort en ruta.</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-crusoe-200 shadow-md">
                ...
                <div className="p-4 bg-crusoe-50">
                  <h4 className="font-bold text-crusoe-950 text-sm">Interior Ejecutivo</h4>
                  <p className="text-xs text-crusoe-800 mt-1">Asientos ergonómicos de cuero, climatización y gran comodidad.</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-crusoe-200 shadow-md">
                ...
                <div className="p-4 bg-crusoe-50">
                  <h4 className="font-bold text-crusoe-950 text-sm">Seguridad y Mantenimiento</h4>
                  <p className="text-xs text-crusoe-800 mt-1">Revisiones técnicas al día, SOAT vigente y desinfección en cada viaje.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* CTA BANNER */}
        <section className="py-16 bg-crusoe-950 text-white relative overflow-hidden">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
              ¿Listo para asegurar tu traslado con Fast Travel Xauxa?
            </h2>
            <p className="text-sm text-crusoe-200 mt-3 max-w-xl mx-auto">
