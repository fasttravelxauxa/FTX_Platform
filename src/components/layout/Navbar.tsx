    ...
    <header className="sticky top-0 z-50 w-full border-b border-crusoe-200/80 bg-white/95 backdrop-blur-md transition-all">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link href="/admin" className="text-xs font-semibold text-crusoe-700 hover:underline px-2 py-1">
            Panel Admin
          </Link>
          <a
            ...
            className="flex flex-col items-start rounded-xl border border-crusoe-300 bg-crusoe-50 px-3 py-1.5 text-xs font-medium text-crusoe-900 hover:bg-crusoe-100 transition-colors"
            title="Coordinación únicamente por mensajes de WhatsApp (No llamadas)"
          >
            <div className="flex items-center gap-1.5 font-bold text-crusoe-800">
              <MessageSquare className="h-3.5 w-3.5 text-crusoe-600" />
              <span>WhatsApp 929 667 586</span>
            </div>
            <span className="text-[9px] text-crusoe-700 font-semibold pl-5">Solo Mensajes</span>
          </a>
          <Link href="/reserva">
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            ...
            className="rounded-lg p-2 text-crusoe-800 hover:bg-crusoe-100 focus:outline-none"
